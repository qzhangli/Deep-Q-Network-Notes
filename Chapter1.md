...
因此需要引入discount rate: 0 <= gamma <= 1
The larger the gamma, the agent cares more about the long term reward.
The smaller the gamma, the agent cares more about the short term reward.
